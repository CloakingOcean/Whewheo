...
/**
 * Receiving Class. Run after a player has been successfully teleported. [Only
 * implemented with warps currently because I don't know of a way to send
 * specific information to another server when a player is teleported]
 * 
 * @author Cloaking_Ocean date Apr 2, 2017
 * @version 1.0
 */
