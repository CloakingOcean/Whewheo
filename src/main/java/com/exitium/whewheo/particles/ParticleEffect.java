...
public enum ParticleEffect {
	 ...
	 * </ul>
	 */
	DRAGONBREATH("dragonbreath", 42, 9), ENDROD("endrod", 43, 9), DAMAGEINDICATOR("damageindicator", 44, 9),
	SWEEPATTACK("sweepattack", 45, 9), FALLINGDUST("fallingdust", 46, 10, ParticleProperty.REQUIRES_DATA),
	...
	private static boolean isDataCorrect(ParticleEffect effect, ParticleData data) {
		return ((effect == BLOCK_CRACK || effect == BLOCK_DUST || effect == FALLINGDUST) && data instanceof BlockData)
